...
public class Students_Infromation_System extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_close.setBackground(new java.awt.Color(204, 204, 204));
        ...
        txt_home.setBackground(new java.awt.Color(204, 204, 204));
        txt_home.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txt_home.setForeground(new java.awt.Color(51, 51, 51));
    ...
    private void cmd_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_searchActionPerformed
        ...
        try {
            ...
            if(rs.next())
            {
                ...
                String add4=rs.getString("Taken");
        ...
        try {
            String sql="select  * from  student_info where Taken=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1, cmd_search.getText());
    ...
    private void cmd_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_saveActionPerformed
        ...
        try {
            ...
            String sql="insert into student_info (Roll,First_name,Last_name,Taken,Year,Birth_date,Mobile_no,Sex,permanent,Present) values(?,?,?,?,?,?,?,?,?,?)";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(p==0)
        {
           try {
            ...
            String sql="Update student_info set Roll='"+value1+"',First_name='"+value2+"',Last_name='"+value3+"',Taken='"+value4+"', Year='"+value5+"',Birth_date='"+value6+"',Mobile_no='"+value7+"',Sex='"+value8+"',permanent='"+value9+"',Present='"+value10+"' where Roll='"+value1+"'";        
