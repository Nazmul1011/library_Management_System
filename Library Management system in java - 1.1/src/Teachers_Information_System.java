...
public class Teachers_Information_System extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(90, 135, 241));
        ...
        txt_texit.setBackground(new java.awt.Color(204, 204, 204));
        txt_texit.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txt_texit.setForeground(new java.awt.Color(51, 51, 51));
        ...
        txt_tclear.setBackground(new java.awt.Color(204, 204, 204));
        txt_tclear.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txt_tclear.setForeground(new java.awt.Color(51, 51, 51));
        ...
        cmd_tdelete.setBackground(new java.awt.Color(204, 204, 204));
        cmd_tdelete.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cmd_tdelete.setForeground(new java.awt.Color(51, 51, 51));
        ...
        cmd_tsave.setBackground(new java.awt.Color(204, 204, 204));
        cmd_tsave.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cmd_tsave.setForeground(new java.awt.Color(51, 51, 51));
        ...
        txt_tupdate.setBackground(new java.awt.Color(204, 204, 204));
        txt_tupdate.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txt_tupdate.setForeground(new java.awt.Color(51, 51, 51));
        ...
        jLabel1.setText("Book serial no:");
        ...
        jLabel16.setText("BOOk's Information System");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(txt_teacher_ID, javax.swing.GroupLayout.DEFAULT_SIZE, 116, Short.MAX_VALUE)
...
//        txt_present.setText("");
    ...
    private void cmd_tdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_tdeleteActionPerformed
        ...
        if(p==0)
        {
        String sql="delete from book_information where Book_serial=?";
        try {
    ...
    private void cmd_tsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_tsaveActionPerformed
        ...
        try {
            ...
            String sql="insert into book_information (Book_serial,Book_name,Author_name,Edition,Enter_day) values(?,?,?,?,?)";
...
//            String value10=txt_present.getText();
      ...
      //teacher_info
            ...
            String sql="Update book_information set Book_serial ='"+value1+"',Book_name='"+value2+"',Author_name='"+value3+"',Edition='"+value4+"',Enter_day='"+value6+"', where Book_serial='"+value1+"'";
    ...
    private void cmd_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_searchActionPerformed
        ...
        try {
            String sql="select  * from  book_information where Book_serial=?";
            pst=conn.prepareStatement(sql);
            ...
            if(rs.next())
            {
                ...
                String add1=rs.getString("Book_serial");
                ...
                String add5=rs.getString("Enter_day");
...
//                txt_present.setText(add9);
            ...
            JOptionPane.showMessageDialog(null,"We face a Problem.");
                               ...
                               try {
            String sql="select  * from  book_information where Author_name=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1, cmd_search.getText());
...
//                txt_present.setText(add9);
            ...
            JOptionPane.showMessageDialog(null,"We face a Problem.");
                  ...
                  try {
            String sql="select  * from  book_information where Edition=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1, cmd_search.getText());
...
//                txt_present.setText(add9);
           ...
           // pst=conn.prepareStatement(sql);
            ...
            if(rs.next())
            {
                ...
                String add1=rs.getString("Book_serail");
                txt_teacher_ID.setText(add1);
